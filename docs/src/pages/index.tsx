...
const Home: NextPage = () => {
  return (
    <LandingLayout
      seo={{ title: 'Hardhat', description: 'Ethereum development environment for professionals by Nomic Foundation' }}
    >
      <HeroBlock />
      ...
      <WhyHardhatBlock>
        ...
        <FeatureCard content={FeatureCards.featureCardThree} isReversed={true} />
